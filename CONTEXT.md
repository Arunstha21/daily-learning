...
- Status: Created (catch-up); learner completion not yet confirmed
...
- Read AGENTS.md, GUIDE.md, CONTEXT.md, MEMORY.md, newest lesson (AI-001), and due/overdue review context.
- Created Level-1 lesson `BE-001` in `04_Business_and_Economics/` on opportunity cost (value of the next-best alternative given up).
- Created review file `08_Reviews/REVIEW_2026-07-28.html` covering AI-001 +1 day and still-pending ITF-001 / PC-001 items.
- Created `tech-news/2026-07-28-AM.html` (Nvidia Open Secure AI Alliance, Chinese domestic DUV lithography reports, Samsung–Broadcom $200B+ deal, Nvidia–OpenAI financing talks, Microsoft AI security tools, Nvidia–SSI investment).
