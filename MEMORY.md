...
- Read AGENTS.md, GUIDE.md, CONTEXT.md, MEMORY.md, AI-001, and review context.
- Created Level-1 lesson `BE-001` on opportunity cost (value of the next-best alternative forgone; time/money/attention; distinction from accounting cost and sunk cost). Sources: standard introductory economics framing.
- Created `08_Reviews/REVIEW_2026-07-28.html` covering AI-001 +1 day and still-pending ITF-001 / PC-001.
- Created `tech-news/2026-07-28-AM.html`.
- Updated `index.html`, `CONTEXT.md`, and this `MEMORY.md`.
- Next rotation step: Science and Critical Thinking.
